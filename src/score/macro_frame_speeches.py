"""
Macro-Frame Annotation on ParlaMint Speeches
======================================================
Scores climate utterances from ParlaMint-NL on 7 macro-frames
using a Likert 1-5 schema.

Input:  results/speeches/utterances.csv
Output: results/speeches/macro_scores/{MODEL_SHORT}.csv
"""
...
DATA_PATH      = "results/speeches/utterances.csv"
TEXT_COL       = "text"
BATCH_SIZE     = 32
MAX_NEW_TOKENS = 8
OUT_DIR        = Path("results/speeches/macro_scores")
...
FRAMES = {
    "economic": {
        ...
        "examples": {
            ...
            5: "The text argues climate levies destroy purchasing power, make industry uncompetitive. -- Pure economic reasoning.",
        },
    ...
    "moral": {
        ...
        "examples": {
            1: "The text requests an investigation into hydrogen storage capacity. -- No moral dimension.",
            2: "The text briefly states the Netherlands has a responsibility to lead on climate. -- Responsibility named once, dropped immediately.",
            3: "The text argues the Netherlands bears a special obligation to lead and future generations must not inherit a destabilized climate. -- Moral argument present alongside other framing.",
            4: "The text argues repeatedly that wealthy nations have a historical debt and inaction violates intergenerational justice. -- Moral reasoning central throughout.",
            5: "The text argues we owe it to our children and to developing nations. Acting is a moral imperative. -- Pure moral logic.",
        },
    ...
    "scientific": {
        ...
        "examples": {
            ...
            3: "The text cites PBL findings that current policy is insufficient. -- One empirical source cited and used as argument.",
            4: "The text cites IPCC thresholds, PBL analysis, and KNMI projections. -- Evidence-based reasoning is primary.",
            5: "Every clause cites a specific IPCC AR6 conclusion or PBL projection. -- Pure evidence-based reasoning.",
        },
    ...
    "health_environment": {
        ...
        "examples": {
            ...
            3: "The text cites declining marine biodiversity and names protected species at risk. -- Specific impact cited as argument.",
            4: "The text describes heat stress mortality, respiratory disease, flooding risk, and biodiversity collapse. -- Health and environmental impacts are primary.",
    ...
    "weaponization": {
        ...
        "examples": {
            ...
            3: "The text argues nitrogen policy disproportionately burdens farmers while exempting aviation, framing this as politically motivated. -- Political unfairness named.",
...
def build_prompt(frame_key: str, text: str) -> str:
    ...
    return (
        ...
        f"Score the following Dutch parliamentary speech utterance on the '{f['label']}' frame.\n\n"
        f"## Decision Rule\n{f['decision_rule']}\n\n"
        f"## Likert Scale\n{LIKERT_DEFINITIONS}\n\n"
        f"## Scoring Anchors\n{anchors}\n\n"
        f"## Calibration Examples\n{examples}\n\n"
        f"## Utterance to Score (Dutch)\n{text}\n\n"
        f"## Question\n{f['llm_question']}\n\n"
...
def score_frame(frame_key, df, model, tokenizer, ckpt_dir, model_short):
